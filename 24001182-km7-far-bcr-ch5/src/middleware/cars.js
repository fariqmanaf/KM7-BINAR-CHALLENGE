...
const validateCreateCar = async (req, res, next) => {
    ...
    if (!resultValidateBody.success) {
        return res
            .status(400)
            .json({ errors: resultValidateBody.error.errors });
    }
    ...
    try {
        ...
        if (!resultValidateParams.success) {
            console.log(
                ...
                resultValidateParams.error.errors
            );
            throw new BadRequestError(resultValidateParams.error.errors);
        }
        ...
        const validateBody = z.object({
            ...
            option_details_id: z
                .array(z.number().positive().optional())
                .optional(),
            spec_details_id: z
                .array(z.number().positive().optional())
                .optional(),
        ...
        if (!resultValidateBody.success) {
            console.log(
                ...
                resultValidateBody.error.errors
            );
        ...
        if (!resultValidateFileBody.success) {
            console.log(
                ...
                resultValidateFileBody.error.errors
            );
